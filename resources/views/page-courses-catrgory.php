        ...
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 clearfix">
          <div class="irs-log-reg">
            <ul class="list-inline">
              <li><a href="#"><div data-toggle="modal" data-target=".bs-example-modal-lg" data-whatever="@mdo">Login</div></a>
              ...
              <li><a href="#">.</a></li>
              <li class="irs-reg"><a href="#">Register</a></li>
              <li class="irs-search">
          ...
          <div class="container irs-pad-zero">
            ...
            <div class="navbar-header">
              <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#navbar-menu"> <i class="fa fa-bars"></i> </button>
	            <a class="navbar-brand" href="#brand"><img src="images/header-logo-l2.png" class="logo" alt="header-logo-l2.png"></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
               <ul class="nav navbar-nav navbar-center">
                ...
                <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Events</a>
                  <ul class="dropdown-menu">
                    <li><a href="page-contact.html">Contact Us</a></li>                  </ul>
                </li>
                <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Blog</a>
                  <ul class="dropdown-menu">
                    <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Blog Classic</a>
                      <ul class="dropdown-menu">
                        <li><a href="page-blog-left-sidebar.html">Sidebar left</a></li>
                        <li><a href="page-blog-right-sidebar.html">Sidebar Right</a></li>
                        <li><a href="page-blog-sidebar-less.html">Sidebar Less</a></li>
                      </ul>
                    </li>
                    <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Blog Single</a>
                      <ul class="dropdown-menu">
                        <li><a href="page-blog-single-left-sidebar.html">Sidebar left</a></li>
                        <li><a href="page-blog-single-right-sidebar.html">Sidebar Right</a></li>
                        <li><a href="page-blog-single-sidebar-less.html">Sidebar Less</a></li>
                      </ul>
                    </li>
                  </ul>
                </li>
        ...
        <div class="col-sm-12 col-md-8 col-lg-9 clearfix">
          ...
          <div class="row irs-all-course-bb clearfix">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 clearfix">
              <div class="irs-lc-grid style2 text-center">
                ...
                <div class="irs-lc-details style2">
                  ...
                  <h4 class="irs-extraspce style2"><a href="#">African American Studies (AFRICAM)</a></h4>
                </div>
                <div class="irs-lc-footer">
                  <div class="irs-lc-normal-part">
                    <ul class="list-inline">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 clearfix">
              <div class="irs-lc-grid style2 text-center">
                ...
                <div class="irs-lc-details">
                  ...
                  <h4 class="irs-extraspce style2"><a href="#">Bosnian, Croatian, Serbian (BOSCRSR)</a></h4>
                </div>
                <div class="irs-lc-footer">
                  <div class="irs-lc-normal-part">
                    <ul class="list-inline">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 clearfix">
              <div class="irs-lc-grid style2 text-center">
                <div class="irs-lc-grid-thumb">
                  ...
                  <div class="irs-lc-overlay"></div>
                  <div class="irs-lc-price">$21.99</div>
                </div>
                <div class="irs-lc-details style2">
                  <div class="irs-lc-teacher-info">
                    <div class="irs-lct-thumb"><img src="images/courses/s3.png" alt="s6.png"></div>
                ...
                <div class="irs-lc-footer">
                  <div class="irs-lc-normal-part">
                    <ul class="list-inline">
                      <li><a href="#"><i class="fa fa-users"></i> 3219</a></li>
                      <li><a href="#"><i class="fa fa-commenting"></i> 432</a></li>
                    </ul>
                  </div>
                  <div class="irs-lc-hover-part">See Course</div>
                </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 clearfix">
              <div class="irs-lc-grid style2 text-center">
                <div class="irs-lc-grid-thumb">
                  <img class="img-responsive img-fluid" src="images/courses/9.jpg" alt="8.jpg">
                  <div class="irs-lc-overlay"></div>
                  <div class="irs-lc-price">$39.99</div>
                </div>
                <div class="irs-lc-details style2">
                  <div class="irs-lc-teacher-info">
                    <div class="irs-lct-thumb"><img src="images/courses/s5.png" alt="s6.png"></div>
                    <div class="irs-lct-info">with <span class="text-thm2"> Meryl Hawkinson</span></div>
                  </div>
                  <h4><a href="#">Business & Management Studies</a></h4>
                </div>
                <div class="irs-lc-footer">
                  <div class="irs-lc-normal-part">
                    <ul class="list-inline">
                      <li><a href="#"><i class="fa fa-users"></i> 187</a></li>
                      <li><a href="#"><i class="fa fa-commenting"></i> 19</a></li>
                    </ul>
                  </div>
                  <div class="irs-lc-hover-part">See Course</div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 clearfix">
              <div class="irs-lc-grid style2 text-center">
                <div class="irs-lc-grid-thumb">
                  <img class="img-responsive img-fluid" src="images/courses/10.jpg" alt="8.jpg">
                  <div class="irs-lc-overlay"></div>
                  <div class="irs-lc-price">$50</div>
                </div>
                <div class="irs-lc-details style2">
                  <div class="irs-lc-teacher-info">
                    <div class="irs-lct-thumb"><img src="images/courses/s3.png" alt="s6.png"></div>
                  ...
                  <h4><a href="#">Geography & Environmental Sciences</a></h4>
                </div>
                <div class="irs-lc-footer">
                  <div class="irs-lc-normal-part">
                    <ul class="list-inline">
                      <li><a href="#"><i class="fa fa-users"></i> 459</a></li>
                      <li><a href="#"><i class="fa fa-commenting"></i> 197</a></li>
                    </ul>
                  </div>
                  <div class="irs-lc-hover-part">See Course</div>
                </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 clearfix">
              <div class="irs-lc-grid style2 text-center">
                <div class="irs-lc-grid-thumb">
                  <img class="img-responsive img-fluid" src="images/courses/11.jpg" alt="8.jpg">
                  <div class="irs-lc-overlay"></div>
                  <div class="irs-lc-price">free</div>
                </div>
                <div class="irs-lc-details style2">
                  <div class="irs-lc-teacher-info">
                    <div class="irs-lct-thumb"><img src="images/courses/s4.png" alt="s6.png"></div>
                    <div class="irs-lct-info">with <span class="text-thm2"> Meryl Hawkinson</span></div>
                  </div>
                  <h4><a href="#">Applied Science and Best Technology (AST)</a></h4>
                </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 clearfix">
              <div class="irs-lc-grid style2 text-center">
                <div class="irs-lc-grid-thumb">
                  <img class="img-responsive img-fluid" src="images/courses/12.jpg" alt="8.jpg">
                  <div class="irs-lc-overlay"></div>
                ...
                <div class="irs-lc-details style2">
                  ...
                  <h4><a href="#">Dentistry & Teeth Class Operations</a></h4>
                </div>
                <div class="irs-lc-footer">
                  <div class="irs-lc-normal-part">
                    <ul class="list-inline">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 clearfix">
              <div class="irs-lc-grid style2 text-center">
                <div class="irs-lc-grid-thumb">
                  <img class="img-responsive img-fluid" src="images/courses/13.jpg" alt="8.jpg">
                  <div class="irs-lc-overlay"></div>
                  <div class="irs-lc-price">free</div>
                </div>
                <div class="irs-lc-details style2">
                  ...
                  <h4><a href="#">Hands Sculpts Clay Crafts Pottery Class</a></h4>
                </div>
                <div class="irs-lc-footer">
                  <div class="irs-lc-normal-part">
                    <ul class="list-inline">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 clearfix">
              <div class="irs-lc-grid style2 text-center">
                <div class="irs-lc-grid-thumb">
                  <img class="img-responsive img-fluid" src="images/courses/14.jpg" alt="8.jpg">
                  <div class="irs-lc-overlay"></div>
                  <div class="irs-lc-price">$34.99</div>
                </div>
                <div class="irs-lc-details style2">
                  <div class="irs-lc-teacher-info">
                  ...
                  <h4><a href="#">History of Art, Architecture & Design</a></h4>
                </div>
                <div class="irs-lc-footer">
                  <div class="irs-lc-normal-part">
                    <ul class="list-inline">
                      <li><a href="#"><i class="fa fa-users"></i> 1009</a></li>
                      <li><a href="#"><i class="fa fa-commenting"></i> 205</a></li>
                    </ul>
                  </div>
                  <div class="irs-lc-hover-part">See Course</div>
                </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 clearfix">
              <div class="irs-lc-grid style2 text-center">
                <div class="irs-lc-grid-thumb">
                  <img class="img-responsive img-fluid" src="images/courses/15.jpg" alt="8.jpg">
                  <div class="irs-lc-overlay"></div>
                  <div class="irs-lc-price">$39.99</div>
                </div>
                <div class="irs-lc-details style2">
                  ...
                  <h4><a href="#">Middle Eastern & African Studies</a></h4>
                </div>
                <div class="irs-lc-footer">
                  <div class="irs-lc-normal-part">
                    <ul class="list-inline">
                      <li><a href="#"><i class="fa fa-users"></i> 289</a></li>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 clearfix">
              <div class="irs-lc-grid style2 text-center">
                <div class="irs-lc-grid-thumb">
                  <img class="img-responsive img-fluid" src="images/courses/16.jpg" alt="8.jpg">
                  <div class="irs-lc-overlay"></div>
                  <div class="irs-lc-price">$50.00</div>
                </div>
                <div class="irs-lc-details style2">
                  <div class="irs-lc-teacher-info">
                    <div class="irs-lct-thumb"><img src="images/courses/s3.png" alt="s6.png"></div>
                  ...
                  <h4><a href="#">Russian & East European Languages</a></h4>
                </div>
                <div class="irs-lc-footer">
                  <div class="irs-lc-normal-part">
                    <ul class="list-inline">
                      <li><a href="#"><i class="fa fa-users"></i> 54</a></li>
                      <li><a href="#"><i class="fa fa-commenting"></i> 4</a></li>
                    </ul>
                  </div>
                  <div class="irs-lc-hover-part">See Course</div>
          ...
          <ul class="list-inline irs-ip-navigation clearfix">
            <li><span class="flaticon-arrows"></span></li>
            <li><a href="#">1</a></li>
            <li><a href="#">2</a></li>
            <li><a href="#">3</a></li>
            <li><span class="flaticon-arrows-1"></span></li>
          </ul>
        </div>
