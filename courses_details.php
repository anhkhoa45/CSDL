...
<?php require_once "libs/DBconnect.php" ?>
...
<?php 
  ...
  try 
  {
    $stmt = $conn->prepare("
      ...
      FROM courses, users 
      WHERE courses.id = $id 
        AND teacher_id = users.id"); 

    $stmt->execute();

    $result = $stmt->setFetchMode(PDO::FETCH_ASSOC); 

    $course_info = $stmt->fetchAll()[0];
  }
      ...
      <div class="row clearfix">
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="irs-courses-details-title">
                <?php
                  echo "<h2>" . $course_info["name"] . "</h2>";
                  echo "<ul class=\"list-inline irs-cl-teacher-info\">";
                  echo "<li class=\"irs-cl-thumb\"><img src=\"assets/images/courses/s4.png\" alt=\"s4.png\"></li>";
                  echo "<li class=\"irs-cl-info\">with <span class=\"text-thm2\"> " . $course_info['teacher'] . "</span></li>";
                  echo "<li> <span class=\"text-thm2 flaticon-social-2\"></span> 189</li>";
                  echo "<li> <span class=\"text-thm2 flaticon-interface-1\"></span> 10</li>";
                  echo "<li class=\"pull-right\"> <a href=\"#\" class=\"btn btn-default irs-button-styledark\"> Take This Course</a></li>";
                  echo "</ul>";
                ?>
              </div>
              <div class="irs-courses-details-thumb">
                <img class="img-responsive img-fluid" src="assets/images/courses/cd1.jpg" alt="cd1.jpg">
                <div class="irs-cdtls-price"><p>$39.99</p></div>
              </div>              
            </div>
          </div>
                ...
                <div class="irs-cdetails-tab">
                  ...
                  <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade in active" id="description">
                      <div class="row">
                        <div class="col-md-5">
                          <div class="irs-cdtls-feture-bot">
                            <ul class="list-group">
                              <li>
                                <a class="list-group-item" href="#"><span class="flaticon-business text-thm2"></span> Lecture <span class="pull-right"> 12 </span></a>
                              </li>
                              <li>
                                <a class="list-group-item" href="#"><span class="flaticon-clock-1 text-thm2"></span> Duration <span class="pull-right"> 2 hrs. </span></a>
                              </li>
                              <li>
                                <a class="list-group-item" href="#"><span class="flaticon-pen text-thm2"></span> Quizzes <span class="pull-right"> 3 </span></a>
                              </li>
                              <li>
                                <a class="list-group-item" href="#"><span class="flaticon-arrows-4 text-thm2"></span> Skill Level <span class="pull-right"> All </span></a>
                              </li>
                              <li>
                                <a class="list-group-item" href="#"><span class="flaticon-people-1 text-thm2"></span> Students <span class="pull-right"> 321 </span></a>
                              </li>
                              <li>
                                <a class="list-group-item" href="#"><span class="flaticon-globe text-thm2"></span> Language <span class="pull-right"> English </span></a>
                              </li>
                              <li>
                        ...
                        <div class="col-md-7">
                          <div class="irs-courses-dtls-second-para">
                            <p>In your study of Linguistics, you will be introduced to the analysis of the nature and structure of human language (including topics such as how words and sentences are formed.</p>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <p class="irs-cdtls-tt-title">weekly timetable</p>
                          <div class="row irs-cdtls-timetsble">
                            <div class="col-md-2"><div class="irs-cdtls-ttbg">1st Year</div></div>
                            <div class="col-md-4"><div class="irs-cc-tt">Courses</div></div>
                            <div class="col-md-6"><div class="irs-cc-tt">Assessment</div></div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-12">
                          <div class="row irs-all-course-bb irs-padb-twnty">
                            <div class="col-md-4 col-md-offset-2">
                              <div class="irs-cc-tt2">Modern Language</div>
                              <ul class="list-unstyled irs-cd-listss">
                                <li>Practical language work </li>
                                <li>Study of important works and/or topics</li>
                                <li>Literature of the language </li>
                              </ul>
                            </div>
                            <div class="col-md-6">
                              <h4 class="irs-cc-tt3">First University examinations:</h4>
                              <p class="irs-firs-exm">Seven written papers, including translation and literature</p>
                            </div>
                          </div>
                          <div class="row irs-padb-twnty">
                            <div class="col-md-4 col-md-offset-2">
                              <div class="irs-cc-tt2">Linguistics</div>
                              <ul class="list-unstyled irs-cd-listss">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="row irs-cdtls-timetsble">
                            <div class="col-md-2"><div class="irs-cdtls-ttbg">2nd Year</div></div>
                            <div class="col-md-4"><div class="irs-cc-tt">Courses</div></div>
                            <div class="col-md-6"><div class="irs-cc-tt">Assessment</div></div>
                          </div>
                        </div>
                      ...
                      <div class="irs-course-sd-teacher">
                          ...
                          <div class="col-md-2 irs-mrgnbtm-sxty">
                            <div class="irs-courses-td-sngle">
                              <div class="irs-ctds-thumb">
                                <img class="img-responsive img-fluid" src="assets/images/team/tsm1.png" alt="tsm1.png">
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          <div class="col-md-2 irs-mrgnbtm-sxty">
                            <div class="irs-courses-td-sngle">
                              <div class="irs-ctds-thumb">
                                <img class="img-responsive img-fluid" src="assets/images/team/tsm2.png" alt="tsm2.png">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-10 irs-mrgnbtm-sxty irs-all-course-bb">
                        ...
                        <div class="row">
                          <div class="col-md-2 irs-mrgnbtm-sxty">
                            <div class="irs-courses-td-sngle">
                              <div class="irs-ctds-thumb">
                                <img class="img-responsive img-fluid" src="assets/images/team/tsm3.png" alt="tsm3.png">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-10 irs-mrgnbtm-sxty irs-all-course-bb">
                      ...
                      <div class="irs-course-sd-teacher">
                        <div class="row">
                          <div class="col-md-2 irs-mrgnbtm-sxty">
                            <div class="irs-courses-td-sngle">
                              <div class="irs-ctds-thumb">
                                <img class="img-responsive img-fluid img-circle" src="assets/images/team/tsm1.png" alt="tsm1.png">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-10 irs-mrgnbtm-sxty irs-all-course-bb">
                        ...
                        <div class="row">
                          <div class="col-md-2 irs-mrgnbtm-sxty">
                            <div class="irs-courses-td-sngle">
                              <div class="irs-ctds-thumb">
                                <img class="img-responsive img-fluid img-circle" src="assets/images/team/tsm2.png" alt="tsm2.png">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-10 irs-mrgnbtm-sxty irs-all-course-bb">
                        ...
                        <div class="row">
                          <div class="col-md-2 irs-mrgnbtm-sxty">
                            <div class="irs-courses-td-sngle">
                              <div class="irs-ctds-thumb">
                                <img class="img-responsive img-fluid img-circle" src="assets/images/team/tsm3.png" alt="tsm3.png">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-10 irs-mrgnbtm-sxty irs-all-course-bb">
        ...
        <div class="col-sm-12 col-md-4 col-lg-3">
          ...
          <div class="irs-sb-lcourses">
            ...
            <div class="irs-sblc-pack">
              <div class="irs-lc-thumb">
                <img class="img-responsive" src="assets/images/courses/s7.png" alt="s7.png">
            ...
            <div class="irs-sblc-pack">
              <div class="irs-lc-thumb">
                <img class="img-responsive" src="assets/images/courses/s8.png" alt="s8.png">
                <div class="irs-sblc-overlay"></div>
              </div>
              <div class="irs-sblc-details">
            ...
            <div class="irs-sblc-pack">
              <div class="irs-lc-thumb">
                <img class="img-responsive" src="assets/images/courses/s9.png" alt="s9.png">
                <div class="irs-sblc-overlay"></div>
              </div>
              <div class="irs-sblc-details">
          ...
          <div class="irs-sb-lcourses">
            ...
            <div class="irs-sblc-pack">
              <div class="irs-lc-thumb">
                <img class="img-responsive" src="assets/images/blog/xs4.png" alt="xs4.png">
                <div class="irs-sblc-overlay"></div>
              </div>
              <div class="irs-sblc-details">
            ...
            <div class="irs-sblc-pack">
              <div class="irs-lc-thumb">
                <img class="img-responsive" src="assets/images/blog/xs5.png" alt="xs4.png">
                <div class="irs-sblc-overlay"></div>
              </div>
              <div class="irs-sblc-details">
            ...
            <div class="irs-sblc-pack">
              <div class="irs-lc-thumb">
                <img class="img-responsive" src="assets/images/blog/xs6.png" alt="xs4.png">
                <div class="irs-sblc-overlay"></div>
              </div>
              <div class="irs-sblc-details">
        ...
        <div class="col-lg-12 irs-pad-zero">
          <div class="irs-lc-carousel">
            <div class="item animatedParent">
              <div class="irs-lc-grid text-center animated growIn delay-250">
                <div class="irs-lc-grid-thumb">
                  <img class="img-responsive img-fluid" src="assets/images/courses/5.jpg" alt="5.jpg">
                  <div class="irs-lc-overlay"></div>
                  <div class="irs-lc-price">free</div>
                </div>
                <div class="irs-lc-details">
                  <div class="irs-lc-teacher-info">
                    <div class="irs-lct-thumb"><img src="assets/images/courses/s3.png" alt="s3.png"></div>
            ...
            <div class="item animatedParent">
              <div class="irs-lc-grid text-center animated growIn delay-250">
                <div class="irs-lc-grid-thumb">
                  <img class="img-responsive img-fluid" src="assets/images/courses/6.jpg" alt="6.jpg">
                  <div class="irs-lc-overlay"></div>
                  <div class="irs-lc-price">$35.99</div>
                </div>
                <div class="irs-lc-details style2">
                  <div class="irs-lc-teacher-info">
                    <div class="irs-lct-thumb"><img src="assets/images/courses/s4.png" alt="s4.png"></div>
            ...
            <div class="item animatedParent">
              <div class="irs-lc-grid text-center animated growIn delay-250">
                <div class="irs-lc-grid-thumb">
                  <img class="img-responsive img-fluid" src="assets/images/courses/7.jpg" alt="7.jpg">
                  <div class="irs-lc-overlay"></div>
                  <div class="irs-lc-price">$40.50</div>
                </div>
                <div class="irs-lc-details">
                  <div class="irs-lc-teacher-info">
                    <div class="irs-lct-thumb"><img src="assets/images/courses/s5.png" alt="s5.png"></div>
                    <div class="irs-lct-info">with <span class="text-thm2"> Jessica Hamson</span></div>
                  </div>
            ...
            <div class="item animatedParent">
              <div class="irs-lc-grid text-center animated growIn delay-250">
                <div class="irs-lc-grid-thumb">
                  <img class="img-responsive img-fluid" src="assets/images/courses/8.jpg" alt="8.jpg">
                  <div class="irs-lc-overlay"></div>
                  <div class="irs-lc-price">free</div>
                </div>
                <div class="irs-lc-details style2">
                  <div class="irs-lc-teacher-info">
                    <div class="irs-lct-thumb"><img src="assets/images/courses/s6.png" alt="s6.png"></div>
